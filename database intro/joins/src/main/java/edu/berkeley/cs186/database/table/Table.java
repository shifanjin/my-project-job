...
public class Table implements Closeable {
    ...
    public class RIDPageIterator implements BacktrackingIterator<RecordId> {
        ...
        private List<RecordId> rids = new ArrayList<RecordId>();
        private int totalrids;
...
//            throw new UnsupportedOperationException("TODO(hw3): implement");
            ...
            for (int i = 0; i < numRecordsPerPage; i++) {
                if (Bits.getBit(bitmap, i) == Bits.Bit.ONE) {
                    RecordId addthisrid = new RecordId(pagenum, (short) i);
                    rids.add(addthisrid);
                }
            }
...
//            throw new UnsupportedOperationException("TODO(hw3): implement");
            ...
            if (this.curindex < this.markindex) {
                return;
            }

            this.markindex = curindex;
...
//            throw new UnsupportedOperationException("TODO(hw3): implement");
            ...
            this.curindex = this.markindex - 1;
        }
    }
