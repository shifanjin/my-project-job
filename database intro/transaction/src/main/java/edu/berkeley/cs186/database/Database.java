...
//            Database.this.activeTransactions.remove(this.transNum);
            ...
            for (Lock eachlock : lockList) {
                ResourceName thisname = eachlock.name;
                lockManager.release(this, thisname);
            }
...
//                LockUtil.ensureSufficientLockHeld(this, getTableContext(tableName), LockType.S);
                LockUtil.ensureSufficientLockHeld(this, getIndexContext(index.getFirst()), LockType.S);
