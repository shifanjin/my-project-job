...
//        set the capacity of the table-level lock contexts appropriately
//          (to the number of children - data and header pages - that the table has).
        lockContext.capacity(numUsedHeaderPages + numPages);
